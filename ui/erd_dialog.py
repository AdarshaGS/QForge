...
from ui.graph_canvas import (
    CARD_RADIUS, CanvasView, CollapseToggle, HeaderItem, MINIMAP_H, MINIMAP_W,
    MinimapView, NODE_W, PAD, ROW_GAP_X, ROW_GAP_Y, ROW_H, HEADER_H,
    build_curved_path, header_color, paint_card,
)
from utils import erd_layout, schema_cache

# Local aliases so the rest of this module reads the way it did before the
# canvas mechanics moved to ui/graph_canvas.py.
_HEADER_H = HEADER_H
_ROW_H = ROW_H
_NODE_W = NODE_W
_PAD = PAD
_ROW_GAP_X = ROW_GAP_X
_ROW_GAP_Y = ROW_GAP_Y
_MARK_SIZE = 9
_MINIMAP_W = MINIMAP_W
_MINIMAP_H = MINIMAP_H
_CARD_RADIUS = CARD_RADIUS
_header_color = header_color
_HeaderItem = HeaderItem
_CollapseToggle = CollapseToggle
_ErdView = CanvasView
...
class _RelationshipLineItem(QGraphicsPathItem):
    ...
    def update_geometry(self):
        ...
        path, t1, t2 = build_curved_path(p1, p2, obstacles)
